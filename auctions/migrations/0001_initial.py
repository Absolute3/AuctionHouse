# Generated by Django 3.2.9 on 2022-02-09 14:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auctions.listing')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('item_bid', models.DecimalField(decimal_places=2, max_digits=15)),
                ('item_title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Name', to='auctions.listing')),
                ('price_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
